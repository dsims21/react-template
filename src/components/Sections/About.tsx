...
const About: FC = memo(() => {
  ...
  return (
    <Section className="bg-neutral-800" sectionId={SectionId.About}>
      <div className={classNames('grid grid-cols-1 gap-4', {'md:grid-cols-4': !!profileImageSrc})}>
        {!!profileImageSrc && (
          <div className="col-span-1 flex justify-center md:justify-start mt-4">
            <div className="relative h-64 w-64 overflow-hidden rounded-xl md:h-64 md:w-64">
